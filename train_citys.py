...
from model.evss_citys import VSSNet
...
def get_arguments():
    ...
    parser.add_argument("--conet_lr", type=float, default=1e-4, help="learning rate of conet")
...
def train():
    ...
    if args.resume:
        ...
        weight = torch.load('/home/mybeast/xjj/EVSS/saved_model/pretrained/csrnet_citys_best.pth', map_location=map_location)
        net.csrnet.load_state_dict(weight, True)
    ...
    for epoch in range(start_epoch, args.num_epoch):
        ...
        for group in flow_optimizer.param_groups:
            print("flownet learning rate: " + str(group['lr']))
        for group in conet_optimizer.param_groups:
            print("conet learning rate: " + str(group['lr']))
